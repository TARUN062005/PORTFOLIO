    ...
    <div className="not-found-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: '#0f172a', color: 'white', fontFamily: 'system-ui, sans-serif', overflow: 'hidden' }}>
      <style>{`
        ...
        .bird-wrapper {
          ...
          align-items: center;
          pointer-events: none; /* Prevents bird animation area from overlapping and blocking clicks */
          margin-bottom: 2rem;
        }
        ...
        .return-btn {
          ...
          position: relative;
          z-index: 50; /* Ensures clicking works */
      ...
      <p className="not-found-subheading">You lost</p>
