  ...
  return (
    ...
    >
      <style>{`
        ...
        /* From Uiverse.io by DanielIdow65799 - Enhanced & Scaled */ 
        .svg-frame {
          position: relative;
          width: 30px;
          height: 30px;
      ...
      <div className="w-full space-y-6 lg:w-3/5 lg:max-w-2xl">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-200 transition-all hover:bg-slate-50 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700 dark:hover:bg-slate-700 active:scale-[0.98]"
          >
            Contact
          </button>
        </div>
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center min-h-[300px] h-[50vh] sm:min-h-[400px] lg:min-h-[500px] overflow-visible">
        {/* From Uiverse.io by DanielIdow65799 */} 
        <div className="scale-100 sm:scale-[1.2] lg:scale-[1.4] xl:scale-[1.6] transition-transform duration-700 ease-out flex items-center justify-center">
          <div className="svg-frame cursor-pointer">
            <svg style={{ '--i': 0, '--j': 0 }}>
            <g id="out1">
              <path
